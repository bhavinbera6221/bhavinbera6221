...
<div class="container rounded bg-black text-white mt-5 mb-5">

    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                <img class="rounded-circle mt-5" src="download.jpg">
                <span class="font-weight-bold">abcd xyz</span><span class="text-black-50">abcd@gmail.com</span>
                <span> </span>
            </div>
        </div>
