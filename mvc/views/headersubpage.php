                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-5 mr-auto">
                        ...
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item active" href="signin">login</a>
                                <a class="dropdown-item @@contact__active" href="registration">Registration</a>
                            </div>
                        </li>
                    </ul>
    ...
    <section class="w3l-breadcrumb">
        <div class="container">
            <ul class="breadcrumbs-custom-path">
                ...
                <li class="active"><span class="fa fa-angle-right mx-2" aria-hidden="true"></span>
                <li><a href="signin">Account</a></li>
                </li>
                <li class="active"><span class="fa fa-angle-right mx-2" aria-hidden="true"></span><?php echo ltrim($_SERVER['PATH_INFO'], "/") ?></li>
            </ul>
        </div>
    </section>