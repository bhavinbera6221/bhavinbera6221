<!--
    ...
    <html lang="en">
      <head>
        ...
        <title>Corp Vision - Corporate Category Bootstrap Responsive Template | About : W3layouts</title>
            ...
            <div class="row team-row">
                <div class="col-lg-3 col-sm-6 team-wrap">
                    <div class="team-member text-center">
                        ...
                        <a href="#team"><h6 class="team-title">	Amelia Jessica</h6></a>
                        <p>Designer</p>
                    </div>
                </div>
                <!-- end team member -->
                ...
                <div class="col-lg-3 col-sm-6 team-wrap mt-sm-0 mt-5">
                    <div class="team-member text-center">
                        ...
                        <a href="#team"><h6 class="team-title">Elizabeth Tracy</h6></a>
                        <p>Photographer</p>
                    </div>
                </div>
                <!-- end team member -->
